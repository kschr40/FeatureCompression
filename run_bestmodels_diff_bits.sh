...
python3 evaluate_best_models_diff_bits.py --dataset $dataset --n_bits_min 4 --n_bits_max 4 --n_steps 100 --n_runs 20 --scratch /scratch/tmp/k_schr40/FeatureCompression --result_folder /scratch/tmp/k_schr40/FeatureCompression/results > /scratch/tmp/k_schr40/FeatureCompression/outdata/$dataset-$timestamp.out
