...
datasets = ['wine', 'california'] # 'california', 'superconduct', 'wine_quality']
...
for data in datasets:
    ...
    for name in os.listdir(path):
        ...
        df = df.rename(columns={'train_loss_mlp': 'Train full precision', 'train_loss_hard_post_mlp':  'Train post minmaxQ',
                                ...
                                'train_loss_soft_hard_mlp':'Train HardQ', 'train_loss_soft_comp_mlp': 'Train Bitwise softQ', 'train_loss_soft_hard_comp_mlp':'Train Bitwise hardQ'})
