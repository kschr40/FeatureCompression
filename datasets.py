...
def get_dataloader(dataset= 'California_Housing', batch_size = 64, random_state= None):
    dataset_list = ['California_Housing']
    assert dataset in dataset_list, f'dataset must be in {dataset_list}'
