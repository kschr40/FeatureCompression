...
from layers import SoftQuantizationLayer, SoftQuantizationPlusLayer, BitwiseSoftQuantizationLayer, MinMaxQuantizationLayer, QuantileQuantizationLayer, quant_lookup_layer, LsqQuanTranspose
...
def train_model(model: nn.Module, 
    ...
    Returns:
        tuple(float, float): best validation loss, training loss of last epoch    
    """
    model.train()
...
def train_SQ(architecture, quantile_thresholds,
                    train_loader, val_loader, test_loader=None,
                    num_epochs=100, learning_rate=0.001, weight_decay=0.0001, add_noise=False,
                    decrease_factor = 0.001, device='cuda', load_model_path=None, dropout = 0.0):
...
def train_SQplus(architecture, quantile_thresholds,
                    train_loader, val_loader, test_loader=None,
                    num_epochs=100, learning_rate=0.001, weight_decay=0.0001, add_noise=False,
                    decrease_factor = 0.001, device='cuda', load_model_path=None, dropout = 0.0):
...
def train_BwSQ(architecture, quantile_thresholds,
                train_loader, val_loader, test_loader=None,
                num_epochs=100, learning_rate=0.001, weight_decay=0.0001, add_noise=False,
                decrease_factor = 0.001, device='cuda', dropout = 0.0):
...
def train_llt(architecture, quantile_thresholds,
              train_loader, val_loader, test_loader=None,
              num_epochs=100, learning_rate=0.001, weight_decay=0.0001, add_noise=False,
...
def train_lsq(architecture, train_loader, val_loader, test_loader=None,
              num_epochs=100, learning_rate=0.001, weight_decay=0.0001, add_noise=False,
              n_bits = 8, decrease_factor = 0.001, device='cuda', load_model_path=None, dropout = 0.0):
